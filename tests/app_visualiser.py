...
axes[0].legend(handles_before, df_app_before_group['Application_Protocol'], title="Protocols", 
               loc='upper center', bbox_to_anchor=(0.5, legend_y_offset), ncol=3, frameon=True)

axes[1].legend(handles_after, df_app_after_group['Application_Protocol'], title="Protocols", 
               loc='upper center', bbox_to_anchor=(0.5, legend_y_offset), ncol=3, frameon=True)
